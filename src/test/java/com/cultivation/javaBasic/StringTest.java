...
class StringTest {
    ...
    void should_be_immutable() {
        ...
        //
        // It is really easy to pass the test. But you have to tell why.  <-- original replaced with new
        // <--start
    ...
    void all_modification_method_will_create_new_string() {
        ...
        // TODO: Please modify the following line to pass the test.
        //
        // It is really easy to pass the test. But you have to tell why. <- space removed
        // <--start
        final Optional<Boolean> areSame = Optional.of(false);
        // --end-->
    ...
    void will_create_new_string_when_concat() {
        ...
        // TODO: Please modify the following line to pass the test.
        //
        // It is really easy to pass the test. But you have to tell why. <- concat two string
        // <--start
        final Optional<Boolean> areSame = Optional.of(false);
        // --end-->
    ...
    void should_taken_string_apart() {
        ...
        final String partOfString = tmp.replace("Java ","");
        // --end-->
    ...
    void should_taken_string_apart_continued() {
        ...
        final String partOfString = arr[1];
        // --end-->
    ...
    void should_convert_unicode_escape() {
        ...
        // れ - U+308c
        // <--Start
        //final String actual = "\U+306a\U+306b\U+3053\U+308c";
		final String actual = "";
        // --End-->
    ...
    void should_reverse_a_string() {
        ...
        // <--Start
		byte[] arrA = original.getBytes();
		byte[] result = new byte [arrA.length];
		for (int i=0;i<arrA.length;i++){
			result[i] = arrA[arrA.length-i-1];
		}
        final String reversed = new String(result);
        // --End-->
